...
class M8L6_FaceSets(FaceSets):
    ...
    def _define_vertices(self, symmetry_string):
        ...
        if symmetry_string in ["d31n", "d32n"]:
            return {
                "001": (0, 1, 2, 3),
                "100": (0, 1, 4, 5),
                "010": (0, 3, 4, 7),
