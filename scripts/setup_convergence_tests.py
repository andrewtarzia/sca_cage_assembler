...
"""
    ...
    all_cage_structures = [
        os.path.join(cage_directory, "C_cl1_quad2_12_th2_optc.mol"),
        os.path.join(cage_directory, "C_cl1_quad2_3_th2_optc.mol"),
        os.path.join(cage_directory, "C_cl1_quad2_8_s62_optc.mol"),
    ]
    ...
    if os.path.exists(dft_directory) and delete_directory:
        input(f"sure you want to delete {dft_directory}? ctrl-C if not!")
