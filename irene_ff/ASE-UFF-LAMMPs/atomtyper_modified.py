...
Description : Assigns UFF atom types to any ASE-readable cristal, and returns the corresponding array.
              ...
              - Modified by Andrew Tarzia to output LAMMPs data file.
"""
...
if __name__ == '__main__':
    ...
    print structure.get_mmtypes()
    print structure.structure.bonds
    # output OPLS structure to LAMMPS file using example from website
    # s = OPLSStructure('172_ext.xyz')
    # opls = OPLSff('172_defs.par')
    # opls.write_lammps(s, prefix='lmp')

    # opls.write_lammps(structure, prefix='lmp')
    # structure.structure.write(name=rootName, fmt='lammps')
