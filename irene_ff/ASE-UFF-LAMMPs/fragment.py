...
class Fragment(Atoms):
    ...
    def write(self, fmt='gulp', name="framework", verbose=True):
        ...
        Modifications:
            Andrew Tarzia added write_lammps function.
        """
        ...
        print extension==""
        if fmt == 'lammps':
            print 'writing to lammps'
            write_lammps(name+".data", self)
        elif (len(extension)==0) or (extension ==".gin"):
