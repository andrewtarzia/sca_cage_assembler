...
def get_all_formEY(property_name, output_file, list_of_names):
    ...
    for name in list_of_names:
        ...
        alde_struc = stk.StructUnit3(alde_file, ['aldehyde'])
        amine_dir = '/data/atarzia/precursor_DBs/reaxys_sorted/'
        if '2f' in amine_name:
            amine_dir += 'amines2f/'
            amine_file = amine_dir+amine_name+'.mol'
            amine_struc = stk.StructUnit2(amine_file, ['amine'])
        ...
        print('Re', reactants)
        formation_energy = calculations.calc_formation_energy(products, reactants)
